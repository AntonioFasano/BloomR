...
```{r br.bulk.csv.demo1, opts.label='runonly'}
read.csv("res/tickers.csv")
```

```{r br.bulk.csv.demo1.show, opts.label='showonly'}
...
```{r br.bulk.csv.demo2, opts.label='bbgtrue', results='hide'}
con=br.open()
```

```{r br.bulk.csv.demo2alt, opts.label='bbgfalse'}
con=NULL
```
```{r br.bulk.csv.demo3, opts.label='runonly'}
data=br.bulk.csv(con, "res/tickers.csv") 
```

```{r br.bulk.csv.demo3.show, opts.label='showonly'}
...
```{r br.bulk.csv.demo5, opts.label='showrun'}
length(data)
names(data)
...
```{r br.bulk.csv.demo6, opts.label='runonly', results='hide'}
data=br.bulk.csv(con, "res/tickers.csv", use.xts=FALSE) 
```
```{r br.bulk.csv.demo6.show, opts.label='showonly'}
data=br.bulk.csv(con, "tickers.csv", use.xts=FALSE) 
```

```{r br.bulk.csv.demo7, opts.label='showrun'}
length(data)
names(data)
class(data$Financial)
...
```{r br.bulk.csv.demo8, opts.label='runonly',  results='hide'}
data=br.bulk.csv(con, "res/tickers.csv", field = "PX_OPEN") 
```

```{r br.bulk.csv.demo8.show, opts.label='showonly'}
...
```{r br.bulk.csv.demo9, opts.label='runonly'}
data=br.bulk.csv(con, "res/tickers.csv", cols=c(1,3))
```

```{r br.bulk.csv.demo9.show, opts.label='showonly'}
...
```{r br.bulk.csv.demo10, opts.label='showrun'}
names(data)
```
...
```{r br.bulk.csv.demo11, opts.label='runonly'}
read.csv("res/tickers.eqt.csv")
```

```{r br.bulk.csv.demo11.show, opts.label='showonly'}
...
```{r br.bulk.csv.demo12, opts.label='runonly', results='hide'}
data=br.bulk.csv(con, "res/tickers.eqt.csv", addtype=TRUE)
```

```{r br.bulk.csv.demo12.show, opts.label='showonly'}
...
```{r br.bulk.desc.exem, opts.label='bbgtrue', results='hide'}
con=br.open()
...
```{r br.bulk.desc.exem.show, opts.label='showonly'}
con=br.open()
