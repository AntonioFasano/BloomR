...
OTS(demo=     list(purl=FALSE, eval=step2,    include=TRUE))
OTS(demoshow= list(purl=FALSE, eval=FALSE,    include=TRUE))
OTS(demorun=  list(purl=FALSE, eval=step2,    include=TRUE, echo=FALSE))
OTS(demorunq= list(purl=FALSE, eval=step2,    include=FALSE))
...
## Set this to FALSE to work at home TO DEL
HAVEBBG=FALSE
...
```{r br.bulk.csv.demo1.show, opts.label='demoshow'}
...
```{r br.bulk.csv.demo2, opts.label='demo'}
con=NULL  #Simulated mode: replace with con=br.open() on terminal
```

```{r br.bulk.csv.demo3.show, opts.label='demoshow'}
...
```{r br.bulk.csv.demo4, opts.label='demo'}
data
```
...
```{r br.bulk.csv.demo5, opts.label='demo'}
length(data)
names(data)
...
```{r br.bulk.csv.demo6.q, opts.label='demorunq'}
data=br.bulk.csv(con, "res/tickers.csv", use.xts=FALSE) 
```
```{r br.bulk.csv.demo6.show, opts.label='demoshow'}
data=br.bulk.csv(con, "mybloomr/tickers.csv", use.xts=FALSE) 
```

```{r br.bulk.csv.demo7, opts.label='demo'}
length(data)
names(data)
class(data$Financial)
...
```{r br.bulk.csv.demo8.show, opts.label='demoshow'}
...
```{r br.bulk.csv.demo11.show, opts.label='demoshow'}
...
```{r br.bulk.desc.exem.show,  opts.label='demoshow'}
con=br.open()
...
```{r br.bulk.tiks.exem, opts.label='demo'}
...
```{r connections.exem, opts.label='demoshow'}
