...
##    At the end of these chunks, functions are moved to "bloomr.usr" enviroment by store().
...
if(grepl("^bloomr\\.beta\\.", current_input()) && !RELEASECAND){
    ...
    detach(bloomr.usr)     # "attach" chunk is run source() and here, I neutralise the first  
}
...
## Once extracted from comments, the actual markdown description is written when a special placeholder is meet.
